  ...
  return (
    <div className="space-y-4">
      <DemoNote tone="wrong">
        ...
        <code>generateStaticParams</code> — every visit is on-demand. Expect an{" "}
        <code>on-demand</code> badge and a changing <code>renderedAt</code>.
      </DemoNote>
      <Link
      ...
      >
        Open on-demand demo (expect on-demand badge) →
      </Link>
    </div>
  );
}
